...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-md-3">
				<div class="jumbotron jumbotron-fluid" style="height:505px;background-color:orange">
					<h4>PHYSICS</h4>
					<p> </p>
					...
					<button id="register" type="button" class="btn btn-danger">Register</button>
					<p> </p>
			...
			<div class="col-md-3">
				<div class="jumbotron jumbotron-fluid" style="height:505px;background-color:orange">
					...
					Important Notes will be provided on regular basis</p>
					<p>Rs: <i class="fa fa-rupee"></i> XXX</p>
					<button id="register1" type="button" class="btn btn-danger">Register</button>
					<p> </p>
					<p style="color:darkred">
						<strong>Validity</strong>: 1 year</p>
				</div>
			...
			<div class="col-md-3">
				<div class="jumbotron jumbotron-fluid" style="height:505px;background-color:orange">
					...
					Important Notes will be provided on regular basis</p>
					<p>Rs: <i class="fa fa-rupee"></i> XXX</p>
					<button id="register2" type="button" class="btn btn-danger">Register</button>
					<p> </p>
					<p style="color:darkred">
						<strong>Validity</strong>: 1 year</p>
				</div>
			...
			<div class="col-md-3">
				<div class="jumbotron jumbotron-fluid" style="height:505px;background-color:orange">
					...
					Important Notes will be provided on regular basis</p>
					<p>Rs: <i class="fa fa-rupee"></i> XXX</p>
					<button id="register3" type="button" class="btn btn-danger">Register</button>
					<p> </p>
					<p style="color:darkred">
						<strong>Validity</strong>: 1 year</p>
				</div>
