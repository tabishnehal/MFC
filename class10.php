...
<div class="allexceptfooter">
	...
	<div class="row pt-4 mt-5">
			<div class="col">
				<div class="jumbotron" style="background-color:tomato">
					<h1>CLASS 10</h1>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-3">
				<div class="jumbotron jumbotron-fluid" style="height:505px;background-color:slateblue">
					<h4>PHYSICS</h4>
					<p> </p>
			...
			<div class="col-md-3">
				<div class="jumbotron jumbotron-fluid" style="height:505px;background-color:slateblue">
					...
					<p>All NCERT and NCERT Exampler's question will be discussed.
						Important Notes will be provided on regular basis</p>
					<p>Rs: <i class="fa fa-rupee"></i> XXX</p>
					<button id="register1" type="button" class="btn btn-success">Register</button>
					<p> </p>
					<p style="color:darkred">
						<strong>Validity</strong>: 1 year</p>
				</div>
			...
			<div class="col-md-3">
				<div class="jumbotron jumbotron-fluid" style="height:505px;background-color:slateblue">
					...
					<p>All NCERT and NCERT Exampler's question will be discussed.
						Important Notes will be provided on regular basis</p>
					<p>Rs: <i class="fa fa-rupee"></i> XXX</p>
					<button id="register3" type="button" class="btn btn-success">Register</button>
					<p> </p>
					<p style="color:darkred">
						<strong>Validity</strong>: 1 year</p>
				</div>
